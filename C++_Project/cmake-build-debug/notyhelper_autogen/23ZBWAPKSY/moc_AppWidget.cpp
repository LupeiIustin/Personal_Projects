...
#include <memory>
#include "../../../client/gui/AppWidget.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_AppWidget_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_AppWidget_t qt_meta_stringdata_AppWidget = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_AppWidget[] = {
...
Q_CONSTINIT const QMetaObject AppWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_AppWidget.offsetsAndSizes,
    qt_meta_data_AppWidget,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_AppWidget_t,
        // Q_OBJECT / Q_GADGET
